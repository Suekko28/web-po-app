        ...
        <div class="content-wrapper">
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin-pengajuan.update', $data[0]->pengajuan_id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('put')
                                        ...
                                        <div class="col-lg-3">
                                            <div class=" mb-3">
                                                <input type="text" class="form-control totalUnit" id="total_unit[{{ $i }}]"
                                                    name="total_unit[{{ $i }}]" value="{{$item->total_unit}}"
                                                    required readonly>
                                            </div>
                                        </div>
                                    </div>
